...
class HeightMap:
    def __init__(self, chikei, heightmap, start_x, start_z, end_x, end_z):
        begin_time = time()
        self.level = chikei
        # self.good_heightmap = heightmap
        self.s_x = start_x
        self.s_z = start_z
        self.e_x = end_x
        self.e_z = end_z
