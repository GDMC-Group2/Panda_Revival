...
#south
def buildHouse_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(15):
        for zz in range(11):
    ...
    #light
    light(editor,x-1,y,z-3)
    light(editor,x+5,y,z-3)
    light(editor,x+18,y,z-3)
    light(editor,x+10,y,z-11)
    light(editor,x+15,y,z-11)
    light(editor,x+10,y,z-7)
    light(editor,x+15,y,z-7)
    light(editor,x-6,y,z-12)
    light(editor,x-15,y,z-12)
    light(editor,x+19,y,z+3)
    light(editor,x+19,y,z+9)
    light(editor,x+18,y,z+16)
    light(editor,x+13,y,z+16)
    light(editor,x+8,y,z+16)
    light(editor,x+3,y,z+16)
    light(editor,x-2,y,z+16)
    light(editor,x-7,y,z+16)
    light(editor,x-14,y,z+16)
...
def window_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
...
def niwa_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(4):
...
def kagu1_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for xx in range(15):
        for zz in range(11):
...
def kitchen_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for yy in range(3):
...
def table_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    for xx in range(3):
...
def bed_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    for zz in range(3):
...
#north
def buildHouse_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(15):
        for zz in range(11):
            editor.placeBlock((x+1+xx,y,z-1-zz),Block(w_id))
    for yy in range(2):       
...
def window_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    editor.placeBlock((x,y+1,z+1),Block(w_id,{"facing": "west", "half": "top", "open": "true"}))
    editor.placeBlock((x+5,y+1,z-1),Block(w_id,{"facing": "east", "half": "top", "open": "true"}))
    for xx in range(3):
        editor.placeBlock((x-8-xx,y,z+11),Block(q_id))
    ...
    for yy in range(5):
        editor.placeBlock((x+10,y+yy,z+3),Block(o_id))
        editor.placeBlock((x+15,y+yy,z+3),Block(o_id))
def niwa_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(4):
        editor.placeBlock((x+1+xx,y,z+11),Block(w_id,{"type": "bottom"}))
        editor.placeBlock((x+1+xx,y,z+5),Block(w_id,{"type": "bottom"}))
...
def kagu1_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for xx in range(15):
        for zz in range(11):
            editor.placeBlock((x+1+xx,y+7,z-1-zz),Block(q_id))
    for xx in range(7):
...
def kitchen_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for yy in range(3):
...
def table_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    for xx in range(3):
        editor.placeBlock((x+5+xx,y+1,z-4),Block(q_id))
        editor.placeBlock((x+5+xx,y+1,z-2),Block(w_id,{"type": "bottom"}))
...
def bed_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    for zz in range(3):
        editor.placeBlock((x-12,y,z+7+zz),Block(q_id,{"axis": "z"}))
        editor.placeBlock((x-9,y,z+7+zz),Block(e_id,{"facing": "east", "half": "bottom", "shape": "straight"}))
        editor.placeBlock((x-10,y,z+7+zz),Block(w_id,{"facing": "west", "part": "foot"}))
...
#west
def buildHouse_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    ...
    #light
    light(editor,z+3,y,x-1) 
    light(editor,z+3,y,x+5)
    light(editor,z+3,y,x+18)
    light(editor,z+11,y,x+10)
    light(editor,z+11,y,x+15)
    light(editor,z+7,y,x+10)
    light(editor,z+7,y,x+15)
    light(editor,z+12,y,x-6)
    light(editor,z+12,y,x-15)
    light(editor,z-3,y,x+19)
    light(editor,z-9,y,x+19)
    light(editor,z-16,y,x+18)
    light(editor,z-16,y,x+13)
    light(editor,z-16,y,x+8)
    light(editor,z-16,y,x+3)
    light(editor,z-16,y,x-2)
    light(editor,z-16,y,x-7)
    light(editor,z-16,y,x-14)
...
def window_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
...
def niwa_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(4):
...
def kagu1_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for xx in range(15):
        for zz in range(11):
...
def kitchen_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for yy in range(3):
...
def table_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    for xx in range(3):
...
def bed_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    for zz in range(3):
...
#east
def buildHouse_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(15):
        for zz in range(11):
            editor.placeBlock((z+1+zz,y,x+1+xx),Block(w_id))
    for yy in range(2):       
...
def window_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    editor.placeBlock((z-1,y+1,x),Block(w_id,{"facing": "north", "half": "top", "open": "true"}))
    editor.placeBlock((z+1,y+1,x+5),Block(w_id,{"facing": "south", "half": "top", "open": "true"}))
    for xx in range(3):
        editor.placeBlock((z-11,y,x-8-xx),Block(q_id))
    ...
    for yy in range(5):
        editor.placeBlock((z-3,y+yy,x+10),Block(o_id))
        editor.placeBlock((z-3,y+yy,x+15),Block(o_id))
def niwa_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id):
    for xx in range(4):
        editor.placeBlock((z-11,y,x+1+xx),Block(w_id,{"type": "bottom"}))
        editor.placeBlock((z-5,y,x+1+xx),Block(w_id,{"type": "bottom"}))
...
def kagu1_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for xx in range(15):
        for zz in range(11):
            editor.placeBlock((z+1+zz,y+7,x+1+xx),Block(q_id))
    for xx in range(7):
    ...
    editor.placeBlock((z+1,y,x+12),Block("glowstone"))
    editor.placeBlock((z+1,y,x+13),Block("glowstone"))
def kitchen_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id,s_id,d_id,f_id,g_id):
    for yy in range(3):
...
def table_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    for xx in range(3):
        editor.placeBlock((z+4,y+1,x+5+xx),Block(q_id))
        editor.placeBlock((z+2,y+1,x+5+xx),Block(w_id,{"type": "bottom"}))
    ...
    editor.placeBlock((z+2,y+3,x+1),Block(y_id))
    editor.placeBlock((z+4,y+2,x+6),Block(u_id))
def bed_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    for zz in range(3):
        editor.placeBlock((z-7-zz,y,x-12),Block(q_id,{"axis": "z"}))
        editor.placeBlock((z-7-zz,y,x-9),Block(e_id,{"facing": "south", "half": "bottom", "shape": "straight"}))
        editor.placeBlock((z-7-zz,y,x-10),Block(w_id,{"facing": "north", "part": "foot"}))
...
def house2_s(editor,x,y,z):
    buildHouse_s(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_s(editor,x,y,z,"grass_block","oak_trapdoor","birch_stairs","air","campfire","poppy","potted_allium","smooth_stone","andesite_wall")
    niwa_s(editor,x,y,z,"stripped_spruce_log","spruce_slab","spruce_trapdoor","spruce_wall_sign","cake","potted_oxeye_daisy","lantern","stone_brick_wall","water","grass_block","lily_pad","bamboo")
    kagu1_s(editor,x,y,z,"oak_planks","bookshelf","jungle_log","jungle_leaves","enchanting_table","lantern","chest","ender_chest","anvil","potted_dark_oak_sapling","potted_poppy","creeper_head","barrel","acacia_door","potted_birch_sapling")
    kitchen_s(editor,x,y,z,"spruce_trapdoor","furnace","smoker","blast_furnace","barrel","lantern","chest","potted_blue_orchid","campfire","oak_stairs","stripped_jungle_log","acacia_log","acacia_leaves","cake","brewing_stand")
    table_s(editor,x,y,z,"oak_planks","oak_slab","oak_trapdoor","potted_fern","potted_cornflower","potted_jungle_sapling","potted_oxeye_daisy")
    bed_s(editor,x,y,z,"stripped_dark_oak_log","light_blue_bed","spruce_stairs","bookshelf","potted_poppy")
def house2_n(editor,x,y,z):
    buildHouse_n(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_n(editor,x,y,z,"grass_block","oak_trapdoor","birch_stairs","air","campfire","poppy","potted_allium","smooth_stone","andesite_wall")
    niwa_n(editor,x,y,z,"stripped_spruce_log","spruce_slab","spruce_trapdoor","spruce_wall_sign","cake","potted_oxeye_daisy","lantern","stone_brick_wall","water","grass_block","lily_pad","bamboo")
    kagu1_n(editor,x,y,z,"oak_planks","bookshelf","jungle_log","jungle_leaves","enchanting_table","lantern","chest","ender_chest","anvil","potted_dark_oak_sapling","potted_poppy","creeper_head","barrel","acacia_door","potted_birch_sapling")
    kitchen_n(editor,x,y,z,"spruce_trapdoor","furnace","smoker","blast_furnace","barrel","lantern","chest","potted_blue_orchid","campfire","oak_stairs","stripped_jungle_log","acacia_log","acacia_leaves","cake","brewing_stand")
    table_n(editor,x,y,z,"oak_planks","oak_slab","oak_trapdoor","potted_fern","potted_cornflower","potted_jungle_sapling","potted_oxeye_daisy")
    bed_n(editor,x,y,z,"stripped_dark_oak_log","light_blue_bed","spruce_stairs","bookshelf","potted_poppy")
def house2_w(editor,z,y,x):
    buildHouse_w(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_w(editor,x,y,z,"grass_block","oak_trapdoor","birch_stairs","air","campfire","poppy","potted_allium","smooth_stone","andesite_wall")
    niwa_w(editor,x,y,z,"stripped_spruce_log","spruce_slab","spruce_trapdoor","spruce_wall_sign","cake","potted_oxeye_daisy","lantern","stone_brick_wall","water","grass_block","lily_pad","bamboo")
    kagu1_w(editor,x,y,z,"oak_planks","bookshelf","jungle_log","jungle_leaves","enchanting_table","lantern","chest","ender_chest","anvil","potted_dark_oak_sapling","potted_poppy","creeper_head","barrel","acacia_door","potted_birch_sapling")
    kitchen_w(editor,x,y,z,"spruce_trapdoor","furnace","smoker","blast_furnace","barrel","lantern","chest","potted_blue_orchid","campfire","oak_stairs","stripped_jungle_log","acacia_log","acacia_leaves","cake","brewing_stand")
    table_w(editor,x,y,z,"oak_planks","oak_slab","oak_trapdoor","potted_fern","potted_cornflower","potted_jungle_sapling","potted_oxeye_daisy")
    bed_w(editor,x,y,z,"stripped_dark_oak_log","light_blue_bed","spruce_stairs","bookshelf","potted_poppy")
def house2_e(editor,z,y,x):
    buildHouse_e(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_e(editor,x,y,z,"grass_block","oak_trapdoor","birch_stairs","air","campfire","poppy","potted_allium","smooth_stone","andesite_wall")
    niwa_e(editor,x,y,z,"stripped_spruce_log","spruce_slab","spruce_trapdoor","spruce_wall_sign","cake","potted_oxeye_daisy","lantern","stone_brick_wall","water","grass_block","lily_pad","bamboo")
    kagu1_e(editor,x,y,z,"oak_planks","bookshelf","jungle_log","jungle_leaves","enchanting_table","lantern","chest","ender_chest","anvil","potted_dark_oak_sapling","potted_poppy","creeper_head","barrel","acacia_door","potted_birch_sapling")
    kitchen_e(editor,x,y,z,"spruce_trapdoor","furnace","smoker","blast_furnace","barrel","lantern","chest","potted_blue_orchid","campfire","oak_stairs","stripped_jungle_log","acacia_log","acacia_leaves","cake","brewing_stand")
    table_e(editor,x,y,z,"oak_planks","oak_slab","oak_trapdoor","potted_fern","potted_cornflower","potted_jungle_sapling","potted_oxeye_daisy")
    bed_e(editor,x,y,z,"stripped_dark_oak_log","light_blue_bed","spruce_stairs","bookshelf","potted_poppy")
def house2(editor,x,y,z,f):
    if f=="n":
        house2_n(editor,x,y,z)
    elif f=="s":
        house2_s(editor,x,y,z)
    elif f=="e":
        house2_e(editor,x,y,z)
    elif f=="w":
        house2_w(editor,x,y,z)
