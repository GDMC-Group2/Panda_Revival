...
def bridge(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    ...
    Lantern(editor,x-5,y,z-6)
    Lantern(editor,x-5,y,z+6)
    Lantern(editor,x+5,y,z-6)
    Lantern(editor,x+5,y,z+6)

def Bridge(editor,x,y,z):
    bridge(editor,x,y,z,"polished_andesite","smooth_stone","smooth_stone_slab","polished_andesite_stairs","lantern","polished_andesite_slab")
