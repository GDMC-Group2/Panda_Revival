...
def entrance(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for yy in range(8):
...
def well(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for yy in range(12):
        for xx in range(3):
            for zz in range(3):
...
def Basement(editor,x,y,z):
    air(editor,x,y-20,z,"air")
    floor(editor,x,y-20,z,"stripped_dark_oak_log","dark_oak_trapdoor","spruce_planks","stone_bricks")
    wall1(editor,x,y-20,z,"spruce_planks","bookshelf","stripped_dark_oak_log","grindstone","lantern")
    wall2(editor,x,y-20,z,"spruce_planks","chest","stripped_dark_oak_log","barrel")
    wall3(editor,x,y-20,z,"stripped_dark_oak_log","bookshelf","enchanting_table","barrel","blast_furnace","smoker","furnace","spruce_planks","red_bed")
    wall4(editor,x,y-20,z,"spruce_planks","stripped_dark_oak_log","grass_block","spruce_fence","spruce_fence_gate","farmland")
    ceiling(editor,x,y-20,z,"stone","dark_oak_slab","stripped_dark_oak_log","dark_oak_trapdoor")
    entrance(editor,x, y-20, z, "scaffolding", "stone_bricks", "stone_brick_stairs", "stone", "cobblestone_wall", "lantern")
    lantern(editor,x,y-20,z,"grindstone","lantern")
    window(editor,x,y-20,z,"glass","spruce_stairs","spruce_slab","air")
    add(editor,x,y-20,z,"stripped_dark_oak_log","glass","water","wheat")
    well(editor,x,y-20,z,"stone_bricks","water","mossy_stone_brick_stairs","mossy_stone_brick_wall","jungle_fence","spruce_trapdoor","spruce_slab","grindstone")
