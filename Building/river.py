...
def River(editor,x,y,z,l,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    for xx in range(l):
        for zz in range(9):
    ...
    for i in range(int(l/3)):
        flower(editor,x-30-random.randint(0,l-6),y-1,z-random.randint(-2,2))
        flower(editor,x+30+random .randint(0,l-6),y-1,z+random.randint(-2,2))
    for i in range(int(2*l/5)):
        grass(editor,x-30-random.randint(0,l-6),y-3,z-random.randint(-2,2))
        grass(editor,x+30+random.randint(0,l-6),y-3,z+random.randint(-2,2))
    ##

def bridge(editor,x,y,z,l,q_id,w_id,e_id,r_id,t_id,y_id):
    m=int(l/2)
    for xx in range(5):
...
def river(editor,x,y,z,L):   
    River(editor,x,y,z,L-27,"air","water","warped_trapdoor","brain_coral_fan","lily_pad","seagrass","kelp_plant","sea_pickle","kelp")
