...
def well(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
...
def Wells(editor,x,y,z):
    well(editor,x,y,z,"cobblestone","cobblestone_wall","hay_block","water","air","wall_torch")
