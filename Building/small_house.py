...
def foundation_s(editor,x,y,z,m_id,e_id): #f=floor e-edge
    for xx in range(2):
...
def wall_s(editor,x,y,z,m_id,p_id):
    for zz in range(4):
        for yy in range(4):
...
#roof
def roof_s(editor,x,y,z,s_id,st_id,c_id):
    #ceiling
    for xx in range(4):
        for zz in range(4):
...
def foundation_w(editor,x,y,z,m_id,e_id): #f=floor e-edge
    for xx in range(2):
...
def wall_w(editor,x,y,z,m_id,p_id):
    for zz in range(4):
        for yy in range(4):
...
#roof
def roof_w(editor,x,y,z,s_id,st_id,c_id):
    #ceiling
    for xx in range(4):
        for zz in range(4):
...
def foundation_n(editor,x,y,z,m_id,e_id): #f=floor e-edge
    for xx in range(2):
        editor.placeBlock((x-1-xx,y,z-7),Block("grass_block"))
        editor.placeBlock((x-5-xx,y,z-7),Block("grass_block"))
...
def wall_n(editor,x,y,z,m_id,p_id):
    for zz in range(4):
        for yy in range(4):
            editor.placeBlock((x-1,y+1+yy,z-2-zz),Block(m_id))
            editor.placeBlock((x-6,y+1+yy,z-2-zz),Block(m_id))
...
#roof
def roof_n(editor,x,y,z,s_id,st_id,c_id):
    #ceiling
    for xx in range(4):
        for zz in range(4):
            editor.placeBlock((x-2-xx,y+5,z-2-zz),Block(c_id))
...
def foundation_e(editor,x,y,z,m_id,e_id): #f=floor e-edge
    for xx in range(2):
        editor.placeBlock((x+7,y,z-1-xx),Block("grass_block"))
        editor.placeBlock((x+7,y,z-5-xx),Block("grass_block"))
...
def wall_e(editor,x,y,z,m_id,p_id):
    for zz in range(4):
        for yy in range(4):
            editor.placeBlock((x+2+zz,y+1+yy,z-1),Block(m_id))
            editor.placeBlock((x+2+zz,y+1+yy,z-6),Block(m_id))
...
#roof
def roof_e(editor,x,y,z,s_id,st_id,c_id):
    #ceiling
    for xx in range(4):
        for zz in range(4):
            editor.placeBlock((x+2+zz,y+5,z-2-xx),Block(c_id))
...
def smallhouse(editor,x,y,z,facing):
    m_id,p_id,r_id = rand_build()
    s_id=r_id+"_slab"
    st_id=r_id+"_stairs"

    if(facing=="s"):
        small_house_s(editor,x,y,z,m_id,p_id,s_id,st_id)
    elif(facing=="w"):
        small_house_w(editor,x,y,z,m_id,p_id,s_id,st_id)
    elif(facing=="n"):
        small_house_n(editor,x,y,z,m_id,p_id,s_id,st_id)
    elif(facing=="e"):
        small_house_e(editor,x,y,z,m_id,p_id,s_id,st_id)


e_id="cobblestone" #土台

def small_house_s(editor,x,y,z,m_id,p_id,s_id,st_id):
    foundation_s(editor,x,y,z,m_id,e_id)
    wall_s(editor,x,y,z,m_id,p_id)
    roof_s(editor,x,y,z,s_id,st_id,m_id)
    furniture_s(editor,x,y,z)

def small_house_w(editor,x,y,z,m_id,p_id,s_id,st_id):
    foundation_w(editor,x,y,z,m_id,e_id)
    wall_w(editor,x,y,z,m_id,p_id)
    roof_w(editor,x,y,z,s_id,st_id,m_id)
    furniture_w(editor,x,y,z)

def small_house_n(editor,x,y,z,m_id,p_id,s_id,st_id):
    foundation_n(editor,x,y,z,m_id,e_id)
    wall_n(editor,x,y,z,m_id,p_id)
    roof_n(editor,x,y,z,s_id,st_id,m_id)
    furniture_n(editor,x,y,z)

def small_house_e(editor,x,y,z,m_id,p_id,s_id,st_id):
    foundation_e(editor,x,y,z,m_id,e_id)
    wall_e(editor,x,y,z,m_id,p_id)
    roof_e(editor,x,y,z,s_id,st_id,m_id)
    furniture_e(editor,x,y,z)
