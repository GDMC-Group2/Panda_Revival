...
def lantern(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    for yy in range(2):
        for xx in range(3):
...
def Lantern(editor,x,y,z):
    lantern(editor,x,y,z,"polished_andesite","polished_andesite_stairs","polished_andesite_slab","oak_trapdoor","shroomlight")
