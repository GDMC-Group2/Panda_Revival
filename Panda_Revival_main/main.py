...
def main():
    ...
    #sが原点
    #gがベクトル値
    editor = Editor(buffering=True,bufferLimit=32768,retries=12)
    ...
    for Area in search_area:
        ...
        surface_reconstruction.RemoveTrees(editor,worldSlice,Area,HM_Area,HMWT_Area)
        SB= SearchBlocks(worldSlice, Area)
        block_id,Biome = SB.run()
