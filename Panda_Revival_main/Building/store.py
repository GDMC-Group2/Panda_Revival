...
#south
#基底
def ground_s(editor,x,y,z,q_id,w_id):
    for xx in range(19):
        for zz in range(11):
            editor.placeBlock((x+xx,y,z+zz),Block(q_id))
  
#柱
def pillar_s(editor,x,y,z,q_id,w_id,e_id):
    #柱第一層
    for yy in range(3):
...
def girder_s(editor,x,y,z,q_id,w_id,e_id):
    #一層
    for xx in range(17):
...
def wall_s(editor,x,y,z,q_id,w_id,e_id,r_id):
    #wall
    for yy in range(3):
        for xx in range(3):
...
#屋根
def tiles_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    #前
    for xx in range(17):
        for yy in range(2):
...
def furniture_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    #レジ
...
def food_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    for xx in range(4):
...
def weapons_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id):
...
def book_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
...
#north
def ground_n(editor,x,y,z,q_id,w_id):
    for xx in range(19):
        for zz in range(11):
            editor.placeBlock((x+xx,y,z-zz),Block(q_id))
  
#柱
def pillar_n(editor,x,y,z,q_id,w_id,e_id):
    #柱第一層
    for yy in range(3):
        editor.placeBlock((x,y+yy,z),Block(q_id))
        editor.placeBlock((x+4,y+yy,z),Block(q_id))
...
def girder_n(editor,x,y,z,q_id,w_id,e_id):
    #一層
    for xx in range(17):
        editor.placeBlock((x+xx,y,z),Block(q_id,{"axis": "x"}))
        editor.placeBlock((x+xx,y,z-8),Block(q_id,{"axis": "x"}))
...
def wall_n(editor,x,y,z,q_id,w_id,e_id,r_id):
    #wall
    for yy in range(3):
        for xx in range(3):
            editor.placeBlock((x+xx,y+yy,z-6),Block(q_id))
...
#屋根
def tiles_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    #前
    for xx in range(17):
        for yy in range(2):
            editor.placeBlock((x+xx,y+yy,z),Block(q_id))
...
def furniture_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    #レジ
    editor.placeBlock((x+3,y+2,z-1),Block(q_id))
    editor.placeBlock((x+3,y+2,z+1),Block(q_id))
    editor.placeBlock((x-3,y+2,z-1),Block(q_id))
...
def food_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    for xx in range(4):
        editor.placeBlock((x-6+xx,y,z+2),Block(q_id,{"axis": "x"}))
        editor.placeBlock((x-6+xx,y+1,z+2),Block(w_id))
        editor.placeBlock((x-6+xx,y,z),Block(q_id,{"axis": "x"}))
...
def weapons_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id):
    editor.placeBlock((x+6,y,z+2),Block(q_id))
    editor.placeBlock((x+6,y,z+1),Block(w_id))
    for xx in range(2):
        editor.placeBlock((x+2+xx,y,z+2),Block(e_id))
    ...
    for yy in range(2):
        ...
        editor.placeBlock((x+1,y+yy,z-2),Block(p_id))
        editor.placeBlock((x+2,y+yy,z-2),Block(a_id))
def book_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    editor.placeBlock((x,y,z-1),Block(q_id))
...
#west
def ground_w(editor,x,y,z,q_id,w_id):
    for xx in range(19):
        for zz in range(11):
            editor.placeBlock((z-zz,y,x+xx),Block(q_id))
   
#柱
def pillar_w(editor,x,y,z,q_id,w_id,e_id):
    #柱第一層
    for yy in range(3):
...
def girder_w(editor,x,y,z,q_id,w_id,e_id):
    #一層
    for xx in range(17):
...
def wall_w(editor,x,y,z,q_id,w_id,e_id,r_id):
    #wall
    for yy in range(3):
        for xx in range(3):
...
#屋根
def tiles_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    #前
    for xx in range(17):
        for yy in range(2):
...
def furniture_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    #レジ
...
def food_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    for xx in range(4):
...
def weapons_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id):
...
def book_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
...
#east
def ground_e(editor,x,y,z,q_id,w_id):
    for xx in range(19):
        for zz in range(11):
            editor.placeBlock((z+zz,y,x+xx),Block(q_id))
  
#柱
def pillar_e(editor,x,y,z,q_id,w_id,e_id):
    #柱第一層
    for yy in range(3):
        editor.placeBlock((z,y+yy,x),Block(q_id))
        editor.placeBlock((z,y+yy,x+4),Block(q_id))
...
def girder_e(editor,x,y,z,q_id,w_id,e_id):
    #一層
    for xx in range(17):
        editor.placeBlock((z,y,x+xx),Block(q_id,{"axis": "x"}))
        editor.placeBlock((z+8,y,x+xx),Block(q_id,{"axis": "x"}))
...
def wall_e(editor,x,y,z,q_id,w_id,e_id,r_id):
    #wall
    for yy in range(3):
        for xx in range(3):
            editor.placeBlock((z+6,y+yy,x+xx),Block(q_id))
...
#屋根
def tiles_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    #前
    for xx in range(17):
        for yy in range(2):
            editor.placeBlock((z,y+yy,x+xx),Block(q_id))
...
def furniture_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id):
    #レジ
    editor.placeBlock((z+1,y+2,x+3),Block(q_id))
    editor.placeBlock((z-1,y+2,x+3),Block(q_id))
    editor.placeBlock((z+1,y+2,x-3),Block(q_id))
...
def food_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id):
    for xx in range(4):
        editor.placeBlock((z-2,y,x-6+xx),Block(q_id,{"axis": "x"}))
        editor.placeBlock((z-2,y+1,x-6+xx),Block(w_id))
        editor.placeBlock((z,y,x-6+xx),Block(q_id,{"axis": "x"}))
...
def weapons_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id,o_id,p_id,a_id):
    editor.placeBlock((z-2,y,x+6),Block(q_id))
    editor.placeBlock((z-1,y,x+6),Block(w_id))
    for xx in range(2):
        editor.placeBlock((z-2,y,x+2+xx),Block(e_id))
    ...
    for yy in range(2):
        ...
        editor.placeBlock((z+2,y+yy,x+1),Block(p_id))
        editor.placeBlock((z+2,y+yy,x+2),Block(a_id))
def book_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id):
    editor.placeBlock((z+1,y,x),Block(q_id))
    ...
    editor.placeBlock((z,y,x-1),Block(t_id))
    editor.placeBlock((z,y,x+2),Block(t_id))
def store1_s(editor,x,y,z):
    ground_s(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_s(editor,x+2,y,z+2,"stone_bricks","spruce_slab","oak_log")
    girder_s(editor,x+1,y+5,z+1,"oak_log","spruce_slab","oak_slab")
    wall_s(editor,x+3,y,z+2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_s(editor,x+1,y+8,z+5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_s(editor,x+9,y,z+5,"lantern","barrel","green_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    food_s(editor,x+9,y,z+5,"stripped_oak_log","cake","melon","honeycomb_block","hay_block","smoker","cartography_table","loom","composter")

def store2_s(editor,x,y,z):
    ground_s(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_s(editor,x+2,y,z+2,"stone_bricks","spruce_slab","oak_log")
    girder_s(editor,x+1,y+5,z+1,"oak_log","spruce_slab","oak_slab")
    wall_s(editor,x+3,y,z+2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_s(editor,x+1,y+8,z+5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_s(editor,x+9,y,z+5,"lantern","barrel","red_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    weapons_s(editor,x+9,y,z+5,"target","fletching_table","stonecutter","anvil","blast_furnace","smithing_table","furnace","iron_block","gold_block","diamond_block","netherite_block")

def store3_s(editor,x,y,z):
    ground_s(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_s(editor,x+2,y,z+2,"stone_bricks","spruce_slab","oak_log")
    girder_s(editor,x+1,y+5,z+1,"oak_log","spruce_slab","oak_slab")
    wall_s(editor,x+3,y,z+2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_s(editor,x+1,y+8,z+5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_s(editor,x+9,y,z+5,"lantern","barrel","blue_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    book_s(editor,x+9,y,z+5,"enchanting_table","lectern","cartography_table","brewing_stand","bookshelf")

def store1_n(editor,x,y,z):
    ground_n(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    ...
    furniture_n(editor,x+9,y,z-5,"lantern","barrel","green_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    food_n(editor,x+9,y,z-5,"stripped_oak_log","cake","melon","honeycomb_block","hay_block","smoker","cartography_table","loom","composter")
 
def store2_n(editor,x,y,z):
    ground_n(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_n(editor,x+2,y,z-2,"stone_bricks","spruce_slab","oak_log")
    girder_n(editor,x+1,y+5,z-1,"oak_log","spruce_slab","oak_slab")
    wall_n(editor,x+3,y,z-2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_n(editor,x+1,y+8,z-5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_n(editor,x+9,y,z-5,"lantern","barrel","red_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    weapons_n(editor,x+9,y,z-5,"target","fletching_table","stonecutter","anvil","blast_furnace","smithing_table","furnace","iron_block","gold_block","diamond_block","netherite_block")

def store3_n(editor,x,y,z):
    ground_n(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_n(editor,x+2,y,z-2,"stone_bricks","spruce_slab","oak_log")
    girder_n(editor,x+1,y+5,z-1,"oak_log","spruce_slab","oak_slab")
    wall_n(editor,x+3,y,z-2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
...
def store1_w(editor,z,y,x):
    ground_w(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
...
def store2_w(editor,z,y,x):
    ground_w(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_w(editor,x+2,y,z-2,"stone_bricks","spruce_slab","oak_log")
    girder_w(editor,x+1,y+5,z-1,"oak_log","spruce_slab","oak_slab")
    wall_w(editor,x+3,y,z-2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_w(editor,x+1,y+8,z-5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_w(editor,x+9,y,z-5,"lantern","barrel","red_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    weapons_w(editor,x+9,y,z-5,"target","fletching_table","stonecutter","anvil","blast_furnace","smithing_table","furnace","iron_block","gold_block","diamond_block","netherite_block")
 
def store3_w(editor,z,y,x):
    ground_w(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_w(editor,x+2,y,z-2,"stone_bricks","spruce_slab","oak_log")
    girder_w(editor,x+1,y+5,z-1,"oak_log","spruce_slab","oak_slab")
    wall_w(editor,x+3,y,z-2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_w(editor,x+1,y+8,z-5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_w(editor,x+9,y,z-5,"lantern","barrel","blue_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    book_w(editor,x+9,y,z-5,"enchanting_table","lectern","cartography_table","brewing_stand","bookshelf")
   
def store1_e(editor,z,y,x):
    ground_e(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_e(editor,x+2,y,z+2,"stone_bricks","spruce_slab","oak_log")
    girder_e(editor,x+1,y+5,z+1,"oak_log","spruce_slab","oak_slab")
    wall_e(editor,x+3,y,z+2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_e(editor,x+1,y+8,z+5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_e(editor,x+9,y,z+5,"lantern","barrel","green_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    food_e(editor,x+9,y,z+5,"stripped_oak_log","cake","melon","honeycomb_block","hay_block","smoker","cartography_table","loom","composter")

def store2_e(editor,z,y,x):
    ground_e(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_e(editor,x+2,y,z+2,"stone_bricks","spruce_slab","oak_log")
    girder_e(editor,x+1,y+5,z+1,"oak_log","spruce_slab","oak_slab")
    wall_e(editor,x+3,y,z+2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_e(editor,x+1,y+8,z+5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_e(editor,x+9,y,z+5,"lantern","barrel","red_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    weapons_e(editor,x+9,y,z+5,"target","fletching_table","stonecutter","anvil","blast_furnace","smithing_table","furnace","iron_block","gold_block","diamond_block","netherite_block")
  
def store3_e(editor,z,y,x):
    ground_e(editor,x,y-1,z,"smooth_stone","stone_brick_slab")
    pillar_e(editor,x+2,y,z+2,"stone_bricks","spruce_slab","oak_log")
    girder_e(editor,x+1,y+5,z+1,"oak_log","spruce_slab","oak_slab")
    wall_e(editor,x+3,y,z+2,"smooth_quartz","acacia_trapdoor","oak_door","acacia_door")
    tiles_e(editor,x+1,y+8,z+5,"polished_andesite","stone_bricks","infested_chiseled_stone_bricks","stone_brick_slab","sea_lantern","spruce_slab")
    furniture_e(editor,x+9,y,z+5,"lantern","barrel","blue_wall_banner","crafting_table","stripped_oak_log","potted_red_tulip","chest")
    book_e(editor,x+9,y,z+5,"enchanting_table","lectern","cartography_table","brewing_stand","bookshelf")
    
def store1(editor,x,y,z,f):
    if f=="n":
        store1_n(editor,x,y,z)
    elif f=="s":
        store1_s(editor,x,y,z)
    elif f=="w":
        store1_w(editor,x,y,z)
    elif f=="e":
        store1_e(editor,x,y,z)
def store2(editor,x,y,z,f):
    if f=="n":
        store2_n(editor,x,y,z)
    elif f=="s":
        store2_s(editor,x,y,z)
    elif f=="w":
        store2_w(editor,x,y,z)
    elif f=="e":
        store2_e(editor,x,y,z)
def store3(editor,x,y,z,f):
    if f=="n":
        store3_n(editor,x,y,z)
    elif f=="s":
        store3_s(editor,x,y,z)
    elif f=="w":
        store3_w(editor,x,y,z)
    elif f=="e":
        store3_e(editor,x,y,z)
