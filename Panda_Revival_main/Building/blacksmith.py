...
def floor_s(editor,x,y,z,f_id,e_id): #f=floorblock e=edge
    #floor
    for xx in range(3):
        for zz in range(3):
...
#roof
def roof_s(editor,x,y,z,r_id): #r=roofblock
    for xx in range(10):
        for zz in range(8):
...
#wall
def wall_s(editor,x,y,z,w_id): #w=wallblock
    for xx in range(10):
...
#furnace
def furnace_s(editor,x,y,z,fc_id,fe_id): #fc=furnace_casing fe=fuenace_edge
    for xx in range(3):
        for zz in range(3):
            for yy in range(3):
...
def floor_e(editor,x,y,z,f_id,e_id): #f=floorblock e=edge
    #floor
    for xx in range(3):
        for zz in range(3):
...
#roof
def roof_e(editor,x,y,z,r_id): #r=roofblock
    for xx in range(10):
        for zz in range(8):
...
#wall
def wall_e(editor,x,y,z,w_id): #w=wallblock
    for xx in range(10):
...
#furnace
def furnace_e(editor,x,y,z,fc_id,fe_id): #fc=furnace_casing fe=fuenace_edge
    for xx in range(3):
        for zz in range(3):
            for yy in range(3):
...
def floor_n(editor,x,y,z,f_id,e_id): #f=floorblock e=edge
    #floor
    for xx in range(3):
        for zz in range(3):
            editor.placeBlock((x-5-xx,y-1,z-3-zz),Block(f_id))
...
#roof
def roof_n(editor,x,y,z,r_id): #r=roofblock
    for xx in range(10):
        for zz in range(8):
            editor.placeBlock((x-xx,y+6,z-zz),Block(r_id,{"type":"bottom"}))
...
#wall
def wall_n(editor,x,y,z,w_id): #w=wallblock
    for xx in range(10):
        editor.placeBlock((x-xx,y+1,z),Block(w_id))
        editor.placeBlock((x-xx,y+2,z),Block(w_id))
    for zz in range(8):
...
#furnace
def furnace_n(editor,x,y,z,fc_id,fe_id): #fc=furnace_casing fe=fuenace_edge
    for xx in range(3):
        for zz in range(3):
            for yy in range(3):
                editor.placeBlock((x-5-xx,y+yy,z-zz),Block(fc_id))
...
def floor_w(editor,x,y,z,f_id,e_id): #f=floorblock e=edge
    #floor
    for xx in range(3):
        for zz in range(3):
            editor.placeBlock((x+3+zz,y-1,z-5-xx),Block(f_id))
...
#roof
def roof_w(editor,x,y,z,r_id): #r=roofblock
    for xx in range(10):
        for zz in range(8):
            editor.placeBlock((x+zz,y+6,z-xx),Block(r_id,{"type":"bottom"}))
...
#wall
def wall_w(editor,x,y,z,w_id): #w=wallblock
    for xx in range(10):
        editor.placeBlock((x,y+1,z-xx),Block(w_id))
        editor.placeBlock((x,y+2,z-xx),Block(w_id))
    for zz in range(8):
...
#furnace
def furnace_w(editor,x,y,z,fc_id,fe_id): #fc=furnace_casing fe=fuenace_edge
    for xx in range(3):
        for zz in range(3):
            for yy in range(3):
                editor.placeBlock((x+zz,y+yy,z-5-xx),Block(fc_id))
...
def blacksmith_main(editor,x,y,z,facing):
    if(facing=='e'):
        blacksmith_e(editor,x,y,z)
    elif(facing=='s'):
        blacksmith_s(editor,x,y,z)
    elif(facing=='w'):
        blacksmith_w(editor,x,y,z)
    elif(facing=='n'):
        blacksmith_n(editor,x,y,z)

def blacksmith_e(editor,x,y,z):
    floor_e(editor,x,y,z,"cobblestone","cobblestone_stairs")
    roof_e(editor,x,y,z,"dark_prismarine_slab")
    wall_e(editor,x,y,z,"cobblestone_wall")
    furnace_e(editor,x,y,z,"polished_blackstone_bricks","polished_blackstone_stairs")
    decorate_e(editor,x,y,z)

def blacksmith_s(editor,x,y,z):
    floor_s(editor,x,y,z,"cobblestone","cobblestone_stairs")
    roof_s(editor,x,y,z,"dark_prismarine_slab")
    wall_s(editor,x,y,z,"cobblestone_wall")
    furnace_s(editor,x,y,z,"polished_blackstone_bricks","polished_blackstone_stairs")
    decorate_s(editor,x,y,z)

def blacksmith_w(editor,x,y,z):
    floor_w(editor,x,y,z,"cobblestone","cobblestone_stairs")
    roof_w(editor,x,y,z,"dark_prismarine_slab")
    wall_w(editor,x,y,z,"cobblestone_wall")
    furnace_w(editor,x,y,z,"polished_blackstone_bricks","polished_blackstone_stairs")
    decorate_w(editor,x,y,z)


def blacksmith_n(editor,x,y,z):
    floor_n(editor,x,y,z,"cobblestone","cobblestone_stairs")
    roof_n(editor,x,y,z,"dark_prismarine_slab")
    wall_n(editor,x,y,z,"cobblestone_wall")
    furnace_n(editor,x,y,z,"polished_blackstone_bricks","polished_blackstone_stairs")
    decorate_n(editor,x,y,z)
