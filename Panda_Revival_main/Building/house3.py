...
def window_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for zz in range(5):
...
def garden_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for xx in range(7):
        for zz in range(5):
    ...
    light(editor,x+3,y,z-6)
    light(editor,x+6,y,z-3)
    light(editor,x-3,y,z+2)
    light(editor,x-3,y,z+10)
    light(editor,x-3,y,z+15)
    light(editor,x+8,y,z+15)
    light(editor,x+19,y,z+15)
    light(editor,x+19,y,z+6)
    light(editor,x+10,y,z-6)
    light(editor,x+15,y,z-6)


def indoor_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(15):
        for zz in range(12):
...
def bed_s(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(3):
        ...
        summon_animal(editor,[x+xx,y+2,z-2],[0,0,0],0,"panda","panda")
...
def kagu_s(editor,x,y,z,r_id,o_id,g_id,l_id,t_id,a_id): #("red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
    for xx in range(4):
        for zz in range(2):
...
def window_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for zz in range(5):
        editor.placeBlock((x,y,z-zz),Block(q_id,{"facing": "east", "half": "top"}))
        editor.placeBlock((x-1,y,z-zz),Block(w_id,{"type": "top"}))
    editor.placeBlock((x-1,y-2,z),Block(e_id))
    ...
    editor.placeBlock((x-1,y-2,z-3),Block(t_id))
    editor.placeBlock((x-1,y-2,z-4),Block(y_id))
def garden_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for xx in range(7):
        for zz in range(5):
            editor.placeBlock((x+xx,y+6,z+3+zz),Block(q_id,{"type": "bottom"}))
    for yy in range(6):
...
def indoor_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(15):
        for zz in range(12):
            editor.placeBlock((x+1+xx,y+7,z-1-zz),Block(q_id))
    for xx in range(3):
    ...
    for zz in range(5):
        editor.placeBlock((x+6,y+2,z-10+zz),Block(i_id,{"facing": "west", "half": "lower", "hinge": "left"}))
        editor.placeBlock((x+6,y+3,z-10+zz),Block(i_id,{"facing": "west", "half": "upper", "hinge": "left"}))
def bed_n(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(3):
        editor.placeBlock((x+xx,y,z),Block(q_id))
        editor.placeBlock((x+xx,y,z+2),Block(w_id,{"facing": "north", "part": "foot"}))
        summon_animal(editor,[x+xx,y+2,z+1],[0,0,0],0,"panda","panda")
        editor.placeBlock((x+xx,y,z+3),Block(e_id,{"facing": "west", "lit": "false"}))
...
def kagu_n(editor,x,y,z,r_id,o_id,g_id,l_id,t_id,a_id): #("red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
    for xx in range(4):
        for zz in range(2):
            editor.placeBlock((x+11+xx,y+1,z-1-zz),Block(r_id))
...
def window_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for zz in range(5):
...
def garden_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for xx in range(7):
        for zz in range(5):
    ...
    light(editor,z-6,y,x+3)
    light(editor,z-3,y,x+6)
    light(editor,z+2,y,x-3)
    light(editor,z+10,y,x-3)
    light(editor,z+15,y,x-3)
    light(editor,z+15,y,x+8)
    light(editor,z+15,y,x+19)
    light(editor,z+6,y,x+19)
    light(editor,z-6,y,x+10)
    light(editor,z-6,y,x+15)



def indoor_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(15):
        for zz in range(12):
...
def bed_e(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(3):
        editor.placeBlock((z,y,x+xx),Block(q_id))
        editor.placeBlock((z-2,y,x+xx),Block(w_id,{"facing": "east", "part": "foot"}))
        summon_animal(editor,[z-1,y+2,x+xx],[0,0,0],0,"panda","panda")
...
def kagu_e(editor,x,y,z,r_id,o_id,g_id,l_id,t_id,a_id): #("red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
    for xx in range(4):
        for zz in range(2):
...
def window_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for zz in range(5):
        editor.placeBlock((z-zz,y,x),Block(q_id,{"facing": "south", "half": "top"}))
        editor.placeBlock((z-zz,y,x-1),Block(w_id,{"type": "top"}))
    editor.placeBlock((z,y-2,x-1),Block(e_id))
    ...
    editor.placeBlock((z-3,y-2,x-1),Block(t_id))
    editor.placeBlock((z-4,y-2,x-1),Block(y_id))
def garden_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id):
    for xx in range(7):
        for zz in range(5):
            editor.placeBlock((z+3+zz,y+6,x+xx),Block(q_id,{"type": "bottom"}))
    for yy in range(6):
...
def indoor_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(15):
        for zz in range(12):
            editor.placeBlock((z-1-zz,y+7,x+1+xx),Block(q_id))
    for xx in range(3):
    ...
    for zz in range(5):
        editor.placeBlock((z-10+zz,y+2,x+6),Block(i_id,{"facing": "north", "half": "lower", "hinge": "left"}))
        editor.placeBlock((z-10+zz,y+3,x+6),Block(i_id,{"facing": "north", "half": "upper", "hinge": "left"}))
def bed_w(editor,x,y,z,q_id,w_id,e_id,r_id,t_id,y_id,u_id,i_id):
    for xx in range(3):
        editor.placeBlock((z,y,x+xx),Block(q_id))
    ...
    editor.placeBlock((z+4,y+4,x+5),Block(i_id))
    editor.placeBlock((z,y+3,x+8),Block(i_id))
def kagu_w(editor,x,y,z,r_id,o_id,g_id,l_id,t_id,a_id): #("red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
    for xx in range(4):
        for zz in range(2):
            editor.placeBlock((z-1-zz,y+1,x+11+xx),Block(r_id))
...
def road_w(editor,x,y,z,q_id):
    for xx in range(23):
        for zz in range(27):
            editor.placeBlock((z+11-zz,y-1,x-3+xx),Block(q_id))
def house3_s(editor,x,y,z):
    road_s(editor,x,y,z,"smooth_stone")
    buildHouse_s(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","dark_prismarine","dark_prismarine","dark_prismarine_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_s(editor,x-1,y+4,z+4,"spruce_stairs","spruce_slab","potted_lily_of_the_valley","potted_oxeye_daisy","potted_poppy","potted_dandelion")
    garden_s(editor,x,y,z,"petrified_oak_slab","stone_brick_wall","poppy","oxeye_daisy","dandelion","polished_andesite_stairs")
    indoor_s(editor,x,y,z,"oak_slab","bookshelf","lectern","enchanting_table","crafting_table","chest","barrel","acacia_door")
    bed_s(editor,x+1,y+1,z+11,"oak_log","light_blue_bed","campfire","stripped_spruce_log","oak_trapdoor","potted_cactus","potted_acacia_sapling","lantern")
    kagu_s(editor,x,y,z,"red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
def house3_n(editor,x,y,z):
    road_n(editor,x,y,z,"smooth_stone")
    buildHouse_n(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","dark_prismarine","dark_prismarine","dark_prismarine_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_n(editor,x-1,y+4,z-4,"spruce_stairs","spruce_slab","potted_lily_of_the_valley","potted_oxeye_daisy","potted_poppy","potted_dandelion")
    garden_n(editor,x,y,z,"petrified_oak_slab","stone_brick_wall","poppy","oxeye_daisy","dandelion","polished_andesite_stairs")
    indoor_n(editor,x,y,z,"oak_slab","bookshelf","lectern","enchanting_table","crafting_table","chest","barrel","acacia_door")
    bed_n(editor,x+1,y+1,z-11,"oak_log","light_blue_bed","campfire","stripped_spruce_log","oak_trapdoor","potted_cactus","potted_acacia_sapling","lantern")
    kagu_n(editor,x,y,z,"red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
def house3_e(editor,z,y,x):
    road_e(editor,x,y,z,"smooth_stone")
    buildHouse_e(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","dark_prismarine","dark_prismarine","dark_prismarine_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_e(editor,x-1,y+4,z+4,"spruce_stairs","spruce_slab","potted_lily_of_the_valley","potted_oxeye_daisy","potted_poppy","potted_dandelion")
    garden_e(editor,x,y,z,"petrified_oak_slab","stone_brick_wall","poppy","oxeye_daisy","dandelion","polished_andesite_stairs")
    indoor_e(editor,x,y,z,"oak_slab","bookshelf","lectern","enchanting_table","crafting_table","chest","barrel","acacia_door")
    bed_e(editor,x+1,y+1,z+11,"oak_log","light_blue_bed","campfire","stripped_spruce_log","oak_trapdoor","potted_cactus","potted_acacia_sapling","lantern")
    kagu_e(editor,x,y,z,"red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
def house3_w(editor,z,y,x):
    road_w(editor,x,y,z,"smooth_stone")
    buildHouse_w(editor,x,y,z, "polished_andesite","smooth_stone","smooth_quartz","stripped_spruce_log","spruce_slab","dark_prismarine","dark_prismarine","dark_prismarine_slab","sea_lantern","smooth_stone_slab","air","polished_andesite_stairs")
    window_w(editor,x-1,y+4,z-4,"spruce_stairs","spruce_slab","potted_lily_of_the_valley","potted_oxeye_daisy","potted_poppy","potted_dandelion")
    garden_w(editor,x,y,z,"petrified_oak_slab","stone_brick_wall","poppy","oxeye_daisy","dandelion","polished_andesite_stairs")
    indoor_w(editor,x,y,z,"oak_slab","bookshelf","lectern","enchanting_table","crafting_table","chest","barrel","acacia_door")
    bed_w(editor,x+1,y+1,z-11,"oak_log","light_blue_bed","campfire","stripped_spruce_log","oak_trapdoor","potted_cactus","potted_acacia_sapling","lantern")
    kagu_w(editor,x,y,z,"red_carpet","orange_carpet","green_carpet","glowstone","birch_stairs","birch_slab")
def house3(editor,x,y,z,f):
    if f=="n":
        house3_n(editor,x,y,z)
    elif f=="s":
        house3_s(editor,x,y,z)
    elif f=="e":
        house3_e(editor,x,y,z)
    elif f=="w":
        house3_w(editor,x,y,z)
