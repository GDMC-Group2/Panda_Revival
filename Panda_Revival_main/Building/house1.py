...
#west
def buildHouse_w(editor,x, y, z, q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):    
    ##柱
    for yy in range(7):
...
def Wall_w(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(2):
    ...
    wall1(editor,x+1,y,z+8)
    wall2(editor,x,y,z)
    wall3(editor,x+8,y,z)

    

def niwa_w(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(3):
...
def farm_w(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID):
    for xx in range(5):
        for zz in range(4):
...
def pool_w(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(4):
        for zz in range(4):
...
def heya_w(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(5):
    ...
    summon_animal(editor,[x+2,y+2,z+5],[0,0,0],0,"panda","panda")
    summon_animal(editor,[x+2,y+2,z+6],[0,0,0],0,"panda","panda")
...
def kagu_w(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID):
...
def road_w(editor,x,y,z,q_id):
    for xx in range(18):
        for zz in range(25):
            editor.placeBlock((x-3+xx,y-1,z-8+zz),Block(q_id))
    light(editor,x+13,y,z-7)
    light(editor,x-2,y,z-7)
    light(editor,x+13,y,z+15)
    light(editor,x-2,y,z+15)
    light(editor,x+13,y,z)
    light(editor,x+13,y,z+8)
    light(editor,x+5,y,z+15)
    light(editor,x+5,y,z-7)
    light(editor,x-2,y,z)
    light(editor,x-2,y,z+8)

  

#east
def buildHouse_e(editor,x, y, z, q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):    
    ##柱
    for yy in range(7):
        editor.placeBlock((x,y+yy,z),Block(q_ID))
        editor.placeBlock((x-8,y+yy,z),Block(q_ID))
...
def Wall_e(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(2):
        editor.placeBlock((x-1-xx,y+6,z),Block(q_ID))
        editor.placeBlock((x-6-xx,y+6,z),Block(q_ID))
        editor.placeBlock((x-2-xx,y+7,z),Block(q_ID))
...
def niwa_e(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(3):
        editor.placeBlock((x-9+xx,y-1,z),Block(e_ID))
    for xx in range(11):
        editor.placeBlock((x-xx,y-1,z-5),Block(e_ID))
...
def farm_e(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID):
    for xx in range(5):
        for zz in range(4):
            editor.placeBlock((x-1-xx,y-1,z+9+zz),Block(q_ID))
            editor.placeBlock((x-1-xx,y,z+9+zz),Block(w_ID,{"age": "7"}))
    ...
    editor.placeBlock((x-6,y+3,z),Block(o_ID,{"hanging": "true"}))
    editor.placeBlock((x-2,y+3,z),Block(o_ID,{"hanging": "true"}))
def pool_e(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(4):
        for zz in range(4):
            editor.placeBlock((x-6-xx,y-1,z-1-zz),Block(q_ID))
    for zz in range(2):
...
def heya_e(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(5):
        editor.placeBlock((x-2-xx,y+4,z-1),Block(q_ID))
    for xx in range(2):
        editor.placeBlock((x-1-xx,y+1,z+7),Block(w_ID))
    ...
    editor.placeBlock((x-1,y+1,z+5),Block(r_ID,{"facing": "south", "part": "foot"}))
    editor.placeBlock((x-2,y+1,z+5),Block(r_ID,{"facing": "south", "part": "foot"}))
    summon_animal(editor,[x-1,y+2,z+6],[0,0,0],0,"panda","panda")
    summon_animal(editor,[x-2,y+2,z+5],[0,0,0],0,"panda","panda")
...
def kagu_e(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID):   
    editor.placeBlock((x-4,y+1,z+8),Block(q_ID))
    editor.placeBlock((x-4,y+2,z+8),Block(q_ID))
...
#north
def buildHouse_n(editor,x, y, z, q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):    
    ##柱
    for yy in range(7):
...
def Wall_n(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(2):
...
def niwa_n(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(3):
...
def farm_n(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID):
    for xx in range(5):
        for zz in range(4):
...
def pool_n(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(4):
        for zz in range(4):
...
def heya_n(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(5):
    ...
    summon_animal(editor,[z+5,y+2,x+2],[0,0,0],0,"panda","panda")
    summon_animal(editor,[z+4,y+2,x-2],[0,0,0],0,"panda","panda")
...
def kagu_n(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID):
...
def road_n(editor,x,y,z,q_id):   
    for xx in range(18):
        for zz in range(25):
            editor.placeBlock((z-8+zz,y-1,x-3+xx),Block(q_id))
    light(editor,z-7,y,x-2)
    light(editor,z-7,y,x+13)
    light(editor,z+15,y,x-2)
    light(editor,z+15,y,x+13)
    light(editor,z,y,x+13)
    light(editor,z+8,y,x+13)
    light(editor,z-7,y,x+6)
    light(editor,z,y,x-2)
    light(editor,z+8,y,x-2)

#south
def buildHouse_s(editor,x, y, z, q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):    
    ##柱
    for yy in range(7):
        editor.placeBlock((z,y+yy,x),Block(q_ID))
        editor.placeBlock((z,y+yy,x-8),Block(q_ID))
...
def Wall_s(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(2):
        editor.placeBlock((z,y+6,x-1-xx),Block(q_ID))
        editor.placeBlock((z,y+6,x-6-xx),Block(q_ID))
        editor.placeBlock((z,y+7,x-2-xx),Block(q_ID))
...
def niwa_s(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID):
    for xx in range(3):
        editor.placeBlock((z,y-1,x-9-xx),Block(e_ID))
    for xx in range(11):
        editor.placeBlock((z-5,y-1,x-xx),Block(e_ID))
...
def farm_s(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID):
    for xx in range(5):
        for zz in range(4):
            editor.placeBlock((z+9+zz,y-1,x-1-xx),Block(q_ID))
            editor.placeBlock((z+9+zz,y,x-1-xx),Block(w_ID,{"age": "7"}))
    ...
    editor.placeBlock((z,y+3,x-6),Block(o_ID,{"hanging": "true"}))
    editor.placeBlock((z,y+3,x-2),Block(o_ID,{"hanging": "true"}))
def pool_s(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(4):
        for zz in range(4):
            editor.placeBlock((z-1-zz,y-1,x-6-xx),Block(q_ID))
    for zz in range(2):
...
def heya_s(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID,o_ID,p_ID,a_ID,s_ID):
    for xx in range(5):
        editor.placeBlock((z-1,y+4,x-2-xx),Block(q_ID))
    for xx in range(2):
        editor.placeBlock((z+7,y+1,x-1-xx),Block(w_ID))
    ...
    editor.placeBlock((z+5,y+1,x-2),Block(r_ID,{"facing": "east", "part": "foot"}))
    summon_animal(editor,[z+5,y+2,x-2],[0,0,0],0,"panda","panda")
    summon_animal(editor,[z+6,y+2,x-2],[0,0,0],0,"panda","panda")
...
def kagu_s(editor,x,y,z,q_ID,w_ID,e_ID,r_ID,t_ID,y_ID,u_ID,i_ID):
    editor.placeBlock((z+8,y+1,x-4),Block(q_ID))
    editor.placeBlock((z+8,y+2,x-4),Block(q_ID))
...
def road_s(editor,x,y,z,q_id):
    ...
    light(editor,z,y,x-13)
    light(editor,z+8,y,x-13)
    light(editor,z-7,y,x-5)    
    light(editor,z,y,x+2)
    light(editor,z+8,y,x+2)



def house1_w(editor,x,y,z):
    road_w(editor,x,y,z,"smooth_stone")
    buildHouse_w(editor,x,y,z, "stripped_spruce_log","spruce_slab","cobblestone","cobblestone_slab","cobblestone_stairs","smooth_stone_slab")
    Wall_w(editor,x,y,z, "oak_planks","sea_lantern","stripped_oak_log","smooth_sandstone","oak_stairs","oak_slab")
    niwa_w(editor,x,y,z,"jungle_leaves","acacia_door","jungle_log","diorite_wall","polished_andesite","oak_door")
    farm_w(editor,x,y,z,"farmland","wheat","water","hay_block","potted_poppy","chest","water_cauldron","mossy_cobblestone_wall","lantern")
    pool_w(editor,x,y,z,"water","rose_bush","lilac","lily_pad","furnace","crafting_table","smoker","blast_furnace","smithing_table","stonecutter","campfire","potted_oxeye_daisy")
    heya_w(editor,x,y,z,"jungle_slab","stripped_spruce_log","barrel","light_blue_bed","spruce_slab","spruce_stairs","oak_trapdoor","lantern","chest","potted_jungle_sapling","potted_pink_tulip","light_gray_carpet")
    kagu_w(editor,x,y,z,"smooth_sandstone","zombie_wall_head","creeper_wall_head","bookshelf","cartography_table","enchanting_table","fletching_table","potted_oxeye_daisy")

def house1_e(editor,x,y,z):
    road_e(editor,x,y,z,"smooth_stone")
    buildHouse_e(editor,x,y,z, "stripped_spruce_log","spruce_slab","cobblestone","cobblestone_slab","cobblestone_stairs","smooth_stone_slab")
    Wall_e(editor,x,y,z, "oak_planks","sea_lantern","stripped_oak_log","smooth_sandstone","oak_stairs","oak_slab")
    niwa_e(editor,x,y,z,"jungle_leaves","acacia_door","jungle_log","diorite_wall","polished_andesite","oak_door")
    farm_e(editor,x,y,z,"farmland","wheat","water","hay_block","potted_poppy","chest","water_cauldron","mossy_cobblestone_wall","lantern")
    pool_e(editor,x,y,z,"water","rose_bush","lilac","lily_pad","furnace","crafting_table","smoker","blast_furnace","smithing_table","stonecutter","campfire","potted_oxeye_daisy")
    heya_e(editor,x,y,z,"jungle_slab","stripped_spruce_log","barrel","light_blue_bed","spruce_slab","spruce_stairs","oak_trapdoor","lantern","chest","potted_jungle_sapling","potted_pink_tulip","light_gray_carpet")
    kagu_e(editor,x,y,z,"smooth_sandstone","zombie_wall_head","creeper_wall_head","bookshelf","cartography_table","enchanting_table","fletching_table","potted_oxeye_daisy")


def house1_n(editor,z,y,x):
    road_n(editor,x,y,z,"smooth_stone")
    buildHouse_n(editor,x,y,z, "stripped_spruce_log","spruce_slab","cobblestone","cobblestone_slab","cobblestone_stairs","smooth_stone_slab")
    Wall_n(editor,x,y,z, "oak_planks","sea_lantern","stripped_oak_log","smooth_sandstone","oak_stairs","oak_slab")
    niwa_n(editor,x,y,z,"jungle_leaves","acacia_door","jungle_log","diorite_wall","polished_andesite","oak_door")
    farm_n(editor,x,y,z,"farmland","wheat","water","hay_block","potted_poppy","chest","water_cauldron","mossy_cobblestone_wall","lantern")
    pool_n(editor,x,y,z,"water","rose_bush","lilac","lily_pad","furnace","crafting_table","smoker","blast_furnace","smithing_table","stonecutter","campfire","potted_oxeye_daisy")
    heya_n(editor,x,y,z,"jungle_slab","stripped_spruce_log","barrel","light_blue_bed","spruce_slab","spruce_stairs","oak_trapdoor","lantern","chest","potted_jungle_sapling","potted_pink_tulip","light_gray_carpet")
    kagu_n(editor,x,y,z,"smooth_sandstone","zombie_wall_head","creeper_wall_head","bookshelf","cartography_table","enchanting_table","fletching_table","potted_oxeye_daisy")


def house1_s(editor,z,y,x):
    road_s(editor,x,y,z,"smooth_stone")
    buildHouse_s(editor,x,y,z, "stripped_spruce_log","spruce_slab","cobblestone","cobblestone_slab","cobblestone_stairs","smooth_stone_slab")
    Wall_s(editor,x,y,z, "oak_planks","sea_lantern","stripped_oak_log","smooth_sandstone","oak_stairs","oak_slab")
    niwa_s(editor,x,y,z,"jungle_leaves","acacia_door","jungle_log","diorite_wall","polished_andesite","oak_door")
    farm_s(editor,x,y,z,"farmland","wheat","water","hay_block","potted_poppy","chest","water_cauldron","mossy_cobblestone_wall","lantern")
    pool_s(editor,x,y,z,"water","rose_bush","lilac","lily_pad","furnace","crafting_table","smoker","blast_furnace","smithing_table","stonecutter","campfire","potted_oxeye_daisy")
    heya_s(editor,x,y,z,"jungle_slab","stripped_spruce_log","barrel","light_blue_bed","spruce_slab","spruce_stairs","oak_trapdoor","lantern","chest","potted_jungle_sapling","potted_pink_tulip","light_gray_carpet")
    kagu_s(editor,x,y,z,"smooth_sandstone","zombie_wall_head","creeper_wall_head","bookshelf","cartography_table","enchanting_table","fletching_table","potted_oxeye_daisy")

def house1(editor,x,y,z,f):
    if f=="n":
        house1_n(editor,x,y,z)
    elif f=="s":
        house1_s(editor,x,y,z)
    elif f=="e":
        house1_e(editor,x,y,z)
    elif f=="w":
        house1_w(editor,x,y,z)
