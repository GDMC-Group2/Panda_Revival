...
def buildBamboo(editor,x,y,z,height):
    for i in range(height):
        editor.placeBlock((x,y+i,z),Block("bamboo",{"age": "1", "leaves": "small"}))

def buildBonsai(editor,x,y,z):
...
def buildFarmHouse(editor,x, y, z):
    for i in range(-4,5):
...
def Farm_water(editor,x,y,z): #光源1
...
def buildFarmland(editor,x,y,z):
    ...
    for i in range(-1,2):
        for j in range(14):
            ...
            editor.placeBlock((x-6-j,y-1,z+i),Block('dirt_path'))
    Farm_water(editor,x+6,y,z+10)
    Farm_water(editor,x+10,y,z+6)
    Farm_water(editor,x+6,y,z+15)
    Farm_water(editor,x+15,y,z+6)
    Farm_water(editor,x+12,y,z+12)
    Farm_water(editor,x+6,y,z-10)
    Farm_water(editor,x+10,y,z-6)
    Farm_water(editor,x+6,y,z-15)
    Farm_water(editor,x+15,y,z-6)
    ...
    editor.placeBlock((x,y-1,z-12),Block("glass"))
    editor.placeBlock((x,y-2,z-12),Block("glowstone"))
    buildBamboo(editor,x+17,y,z+18,5)
    buildBamboo(editor,x+16,y,z+18,6)
    buildBamboo(editor,x+19,y,z+16,7)
    buildBamboo(editor,x+16,y,z+15,5)
    buildBamboo(editor,x+14,y,z+18,6)
    buildBamboo(editor,x+18,y,z+14,7)
    buildBamboo(editor,x+18,y,z+12,7)
    buildBamboo(editor,x+12,y,z+19,6)
    buildBamboo(editor,x+17,y,z-18,5)
    buildBamboo(editor,x+16,y,z-19,6)
    buildBamboo(editor,x+19,y,z-16,7)
    buildBamboo(editor,x+16,y,z-15,5)
    buildBamboo(editor,x+13,y,z-18,6)
    buildBamboo(editor,x+18,y,z-14,7)
    buildBamboo(editor,x+18,y,z-13,7)
    buildBamboo(editor,x+12,y,z-19,6)
    buildBamboo(editor,x-17,y,z+18,5)
    buildBamboo(editor,x-18,y,z+17,6)
    buildBamboo(editor,x-19,y,z+15,7)
    buildBamboo(editor,x-16,y,z+15,5)
    buildBamboo(editor,x-14,y,z+18,6)
    buildBamboo(editor,x-18,y,z+13,7)
    buildBamboo(editor,x-18,y,z+12,7)
    buildBamboo(editor,x-12,y,z+19,6)
    buildBamboo(editor,x-17,y,z-18,5)
    buildBamboo(editor,x-18,y,z-16,6)
    buildBamboo(editor,x-19,y,z-15,7)
    buildBamboo(editor,x-16,y,z-15,5)
    buildBamboo(editor,x-14,y,z-18,6)
    buildBamboo(editor,x-18,y,z-15,7)
    buildBamboo(editor,x-18,y,z-12,7)
    buildBamboo(editor,x-12,y,z-19,6)
    buildBonsai(editor,x+21,y,z+2)
    buildBonsai(editor,x+21,y,z-2)
    buildBonsai(editor,x-21,y,z+2)
    buildBonsai(editor,x-21,y,z-2)
    buildBonsai(editor,x+2,y,z+21)
    buildBonsai(editor,x-2,y,z+21)
    buildBonsai(editor,x+2,y,z-21)
    buildBonsai(editor,x-2,y,z-21)

def buildFarm(editor,x, y, z):
    buildFarmHouse(editor,x,y,z)
    buildFarmland(editor,x,y,z)
